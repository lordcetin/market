...
import { hhnft,hhrpc,hhmarket,hhtoken,hhauction,hhnftcol, cipherEth} from '../engine/configuration';
import { mmnft,mmrpc,mmtoken,mmmarket,mmauction,mmnftcol } from '../engine/configuration';
...
async function connectUser() {
      ...
      // await cosmeta.approve(nftcustom,amount)
      if (window.ethereum) {
