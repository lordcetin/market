...
const AudioPlayer = ({nft,nftname,nftid}) => {
  ...
  return (
    ...
    <Link href={`/details/${nftid}`}><div className="relative left-12 w-96 h-50 welcomebg rounded-lg shadow-2xl shadow-black z-30">
    ...
    <img src="https://ipfs.io/ipfs/QmRgwe8os8GCK5PByT3sqvdjugBEjN32wzW9D6KY5yKiM8" alt="" className={isPlaying ? `relative right-12 animate-spin`: `relative right-12`} />
    </div>
    </div>
    </div>
    ...
    <img src="https://ipfs.io/ipfs/QmRgwe8os8GCK5PByT3sqvdjugBEjN32wzW9D6KY5yKiM8" alt="" className={isPlaying ? `relative right-12 z-30 animate-spin`: `relative right-12 z-30`} />
    </div>
    </div>
    </div>
    <div className="flex justify-center items-center pt-6 pb-[14px] w-full">
    ...
    <div className="flex-col justify-center items-center text-center">
    <div className="flex w-full pt-8">
    <Link href={`/details/${nftid}`}><div className="relative left-12 w-96 h-50 welcomebg rounded-lg shadow-2xl shadow-black z-50">
    <div className="flex-col justify-center items-center text-center overflow-hidden">
    <h1 className="flex justify-center items-center text-xl font-bold my-20">{nftname}</h1>
    <div className="relative bottom-3 left-3 flex w-24">
    <Image src={logo} alt="" width={800} className="absolute bottom-5 z-30" />
    ...
    <img src="https://bafkreifdqokmzap5e5hjb7oz32mfg32lctsq4kizbzqzzv4xlpzyiuujsm.ipfs.nftstorage.link/" alt="" className={isPlaying ? `relative right-12 z-30 animate-spin`: `relative right-12 z-30`} />
    </div>
    </div>
    </div>
    <div className="flex justify-center items-center pt-6 pb-[14px] w-full">
