  ...
  return (
    ...
    {matches => (
      <Fragment>
        ...
        {matches.small &&
          <Fragment>
      <div className="flex-col justify-center items-center px-7 w-full absolute bottom-0 border-t-[1px] border-slate-800">
      ...
      <div className="py-1"><span>Cosmeta &copy; All rights reserved. Dev. <a href="https://ernestsoft.com/" className="border-b-[1px] border-slate-500 text-[11px]">ERNESTSOFT</a></span></div>
      </div>
      </div>
          </Fragment>
        }
