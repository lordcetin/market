          ...
          <div className="flex-col justify-center items-center w-full h-full px-3 pt-20 pb-40 overflow-hidden">
            ...
            <div className="flex-col justify-center items-center w-full">
              ...
              <div className="grid grid-cols-1 grid-rows-6 gap-y-2 py-5">
                  ...
                  {nft.type == 'video/mp4'
                  ? <video src={nft.image} className="w-20 h-20 bg-transparent rounded-lg" autoPlay muted loop/>
                  : nft.type == 'image/png' || nft.type == 'image/jpeg' || nft.type == 'image/jpg' ? <img src={nft.image} className="w-20 h-20 rounded-lg object-cover bg-transparent" />
                  : nft.type == 'audio/mp3' || nft.type == 'audio/wav' || nft.type == 'audio/ogg' || 'audio/mpeg' ? <div className="flex-col justify-between items-center welcomebg w-20 h-20 rounded-lg"><div className="text-[10px] relative top-1/3 flex justify-center items-center text-center">{nft.name}</div></div> : null
                  }
                  </div>
            ...
            <div className="flex-col justify-center items-center w-full">
              <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex justify-center items-center bg-slate-900 py-3 px-3 rounded-lg w-[700px]">
                    ...
                    {nft.type == 'video/mp4'
                    ? <video src={nft.image} className="w-40 h-40 bg-transparent rounded-lg" autoPlay muted loop/>
                    : nft.type == 'image/png' || nft.type == 'image/jpeg' || nft.type == 'image/jpg' ? <img src={nft.image} className="w-40 h-40 rounded-lg object-cover bg-transparent" />
                    : nft.type == 'audio/mp3' || nft.type == 'audio/wav' || nft.type == 'audio/ogg' || 'audio/mpeg' ? <div className="flex-col justify-between items-center welcomebg w-20 h-20 rounded-lg"><div className="text-[10px] relative top-1/3 flex justify-center items-center text-center">{nft.name}</div></div> : null
                    }
                    </div>
